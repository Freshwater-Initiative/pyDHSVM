...
model_output_folder=model_dir+'output/'
model_obs_folder=model_dir+'observations/'
## GIS and DHSVM
gis_folder='C:/Users/cband/Sauk/sediment/SaukSediment-develop/SaukSediment-develop/gis'
dhsvm_dir=model_dir+'dhsvm/'
...
dhsvm_network_folder=dhsvm_dir+'network'
dhsvm_output_folder=model_dir+'dhsvm/'
...
ax1.plot(qmod_mills[q_mills_start_1:q_mills_end_1].index, 
         qmod_mills[q_mills_start_1:q_mills_end_1].values, 
...
ax2.plot(qmod_mills[q_mills_start_2:q_mills_end_2].index, 
         qmod_mills[q_mills_start_2:q_mills_end_2].values, 
         'r',linewidth=1, label='Modeled')
ax2.set_xlabel('Date')
...
plt.loglog(qmod_mills[q_mills_start_1:q_mills_end_1].values,
           qobs_mills.flow_cms[q_mills_start_1:q_mills_end_1].values,
           'bo',markersize=1)
plt.loglog(qmod_mills[q_mills_start_2:q_mills_end_2].values,
           qobs_mills.flow_cms[q_mills_start_2:q_mills_end_2].values,
           'bo',markersize=1)
...
mod=np.concatenate([qmod_mills[q_mills_start_1:q_mills_end_1].values.astype(float),
               qmod_mills[q_mills_start_2:q_mills_end_2].values.astype(float)])
